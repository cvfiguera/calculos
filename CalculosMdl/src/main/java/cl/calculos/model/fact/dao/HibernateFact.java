...
@Transactional(value = "transactionManagerFact")
public class HibernateFact extends HibernateDaoSupport {

	protected Logger log = Logger.getLogger(getClass().getName());

	@Autowired
	public void annyMethodName(@Qualifier("sessionFact") SessionFactory sessionFactory) {
